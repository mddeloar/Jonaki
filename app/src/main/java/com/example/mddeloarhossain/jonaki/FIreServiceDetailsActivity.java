...
public class FIreServiceDetailsActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fire_service_details);

        Intent intent = getIntent();
        //firebaseStorage = FirebaseStorage.getInstance();
        databaseReference = FirebaseDatabase.getInstance().getReference("ambulances").child(intent.getStringExtra(FireServiceActivity.FIRESERVICE_ID));
        ...
        String Name2 = intent.getStringExtra(FireServiceActivity.FIRESERVICE_NAME);
        call=intent.getStringExtra(FireServiceActivity.FIRESERVICE_CONTACTNO);

        name.setText(Name2);
        city.setText(": "+intent.getStringExtra(FireServiceActivity.FIRESERVICE_CITY));
        location.setText(": "+intent.getStringExtra(FireServiceActivity.FIRESERVICE_LOCATION));
        ...
        callButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ActivityCompat.checkSelfPermission(FIreServiceDetailsActivity.this,
        ...
        messageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(FIreServiceDetailsActivity.this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent = (new Intent(FIreServiceDetailsActivity.this, BloodActivity.class));
            startActivity(intent);
    ...
    protected void sendSMS(String number) {
        ...
        try {
            ...
            Toast.makeText(FIreServiceDetailsActivity.this,
