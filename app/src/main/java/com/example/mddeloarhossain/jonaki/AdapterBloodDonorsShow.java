...
public class AdapterBloodDonorsShow extends RecyclerView.Adapter<AdapterBloodDonorsShow.MyViewHolder> implements Filterable {
    ...
    public AdapterBloodDonorsShow(Context context, List<AdapterBloodDonorsShowUpload> uploadList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.blood_donor_recyclerview_layout, parent, false);
    ...
    private Filter exampleFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<AdapterBloodDonorsShowUpload> filteredList = new ArrayList<>();
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                for (AdapterBloodDonorsShowUpload item : uploadList1) {
