...
public class FireServiceActivity extends AppCompatActivity
    ...
    public static final String FIRESERVICE_ID = "com.example.mddeloarhossain.bloodbankm.fireserviceid";



    //************ YOU NEED TO DELETE THIS< THIS IS A BAD IDEA************************//
    public static final String FIRESERVICE_NAME = "com.example.mddeloarhossain.bloodbankm.fireservicename";
    public static final String FIRESERVICE_CITY = "com.example.mddeloarhossain.bloodbankm.fireservicecity";
    public static final String FIRESERVICE_LOCATION = "com.example.mddeloarhossain.bloodbankm.fireservicelocation";
    public static final String FIRESERVICE_CONTACTNO = "com.example.mddeloarhossain.bloodbankm.fireservicecontactno";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                ...
                imageAdapter = new AdapterAmbulanceShow(FireServiceActivity.this, uploadList);
                ...
                imageAdapter.setOnItemClickListener(new AdapterAmbulanceShow.OnItemClickListener() {
                    ...
                    public void OnItemClick(int position) {
                        ...
                        intent.putExtra(FIRESERVICE_ID, key);
                        intent.putExtra(FIRESERVICE_NAME, name);
                        intent.putExtra(FIRESERVICE_CITY, city);
                        intent.putExtra(FIRESERVICE_LOCATION, location);
                        intent.putExtra(FIRESERVICE_CONTACTNO, contactno);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = (new Intent(getApplicationContext(), FireServiceRegistrationActivity.class));
                startActivity(intent);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent = (new Intent(FireServiceActivity.this, BloodActivity.class));
            startActivity(intent);
