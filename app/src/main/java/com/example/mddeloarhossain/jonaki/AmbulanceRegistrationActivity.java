   ...
   /* public static final String DONOR_NAME = "com.example.mddeloarhossain.bloodbankm.donorname";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent = (new Intent(AmbulanceRegistrationActivity.this, BloodActivity.class));
    ...
    public void saveData(){
        ...
        try{
           ...
           /* if(bloodgroup=="Blood Group")
            ...
            AdapterAmbulanceRegistration ambulance = new AdapterAmbulanceRegistration(name, city, location, contactnumber);
